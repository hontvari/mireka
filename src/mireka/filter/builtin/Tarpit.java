...
public class Tarpit {
    ...
    /**
     * The count of expirations the system will store.
     * Add one extra place so that the wait duration does not drop temporarily
     * when a mark expires while otherwise a dictionary attack is ongoing.
     */
