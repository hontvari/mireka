 ...
 * 
 * In addition to IOException, it can originate from an SQL exception, or any other IMAP storage 
 * exception too.
 */
public class MaildataReadException extends RuntimeException {
    private static final long serialVersionUID = 3949930255421607723L;
    public final IOException ioExceptionCause;

    public MaildataReadException(IOException cause) {
        super(cause);
        this.ioExceptionCause = cause;
    }

    public MaildataReadException(Exception cause) {
        super(cause);
        this.ioExceptionCause = null;
    }
}
