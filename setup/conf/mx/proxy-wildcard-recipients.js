/*
	List of wildcard recipients. Mails sent to these recipients will 
	be relayed to the backend server by the SMTP service, when it works in 
	proxy mode.  
...
[
	/*
	setup(AnyDomainRecipient, {
		localPart: new CaseInsensitiveLocalPartSpecification("anonymous")
	}),
